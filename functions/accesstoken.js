...
let serviceAccount = {
    ...
    databaseURL: "https://vml-mobi-first-thing.firebaseio.com"
});

console.log(admin.credential.cert(serviceAccount).getAccessToken())


admin.credential.cert(serviceAccount).getAccessToken().then(function(response){
	DATABASE_ACCESS_TOKEN = "?access_token="+response.access_token;
